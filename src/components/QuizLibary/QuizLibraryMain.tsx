import PaginationCompanent from "./PaginatitonCompanent";
    ...
    <div className="flex flex-col gap-8 w-full min-h-min mx-auto px-10 pt-10 pb-4 bg-BackRCLigthGrey_EFEEFC">
      ...
      <div className="quizlibrary flex flex-col mx-auto items-start justify-start h-[63.5rem] w-[98%] rounded-[2rem] p-8 mb-2 border-2 border-[#EFEEFC] bg-white ">
        ...
        <div className="my-6 flex items-center justify-between w-full">
         ...
         <img src = {arrow} alt="arrowIcon" className="absolute top-0 right-0 -translate-x-6 translate-y-4"/>
         </div>
        
          {/* <SelectComponent /> */}
       
          
          <button className="w-[12.12rem] buttons  HoverAndFocusDark flex justify-center items-center gap-4 py-4 px-8">Create Quiz <span className="font-semibol text-2xl">+</span></button>
          </div>
