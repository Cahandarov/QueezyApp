...
interface userState {
    ...
    isLogined: boolean;
    newUser: {userId: string; email:string; password: string; name:string; surname:string; country:string}
    SignUpStages: 'idle' | 'addEmail' | 'addPassword' | 'addCountry' | 'addNameAndSurname';
    isForgotPassword: boolean;
    ResetPasswordStages: 'ResetEmail' | 'ResetPassword';
...
const initialState :userState = {
    ...
    users:null,
    status: 'idle',
    newUser: {userId: "", email:"", password: "", name:"", surname:"", country:""},
    SignUpStages: 'idle',
...
setAddUser(state, action) {
 ...
 export const {setLoginStatus, setRegisteredStatus, setSignUpStages, 
    setForgotPasswordStatus, setResetPasswordStages, setAddUser} = userSlice.actions;
